...
from vt_plug.utils.constants import (IMAGE_PLACEHOLDER, BOXES_PLACEHOLDER, QUESTION_PLACEHOLDER,
                                    PHRASE_ST_PLACEHOLDER, PHRASE_ED_PLACEHOLDER)
from vt_plug.evaluation.metrics import BaseComputeMetrics
from vt_plug.dataset.single_dataset.mixin import MInstrDataset
