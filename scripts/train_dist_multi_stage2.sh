...
work_dir="/model/Aaronzhu/OkapiModel/vicuna_7b/stage2/0523"
...
# then
#     echo "host5: $host6"
#     NPROC_PER_NODE=8 NNODES=6 ADDR=$host1_addr NODE_RANK=6 PORT=29505 xtuner train configs_okapi/okapi_7b_train_stage2.py --deepspeed deepspeed_zero2  --work-dir $work_dir
# fi
