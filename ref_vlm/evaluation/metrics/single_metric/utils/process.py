...
class SEGDETProcessor:
    def __init__(self,task, 
        ...
        if self.task in ['ade_panoptic','ade_semantic','cityscapes_panoptic']:
            ...
            with open('ref_vlm/evaluation/metrics/single_metric/utils/lvis_classes.json') as f:
                self.test_class_names = json.load(f)
                f.close()
            with open('ref_vlm/evaluation/metrics/single_metric/utils/lvis_class_clip.pkl','rb') as f2:
            ...
            with open('ref_vlm/evaluation/metrics/single_metric/utils/ade20k_instance_classes.json') as f:
            ...
            with open('ref_vlm/evaluation/metrics/single_metric/utils/ade20k_class_clip.pkl','rb') as f2:
                self.test_class_features = pickle.load(f2)
                f2.close()
