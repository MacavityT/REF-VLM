...
from ref_vlm.utils.constants import (IMAGE_PLACEHOLDER, BOXES_PLACEHOLDER, QUESTION_PLACEHOLDER,
                                    PHRASE_ST_PLACEHOLDER, PHRASE_ED_PLACEHOLDER)
from ref_vlm.evaluation.metrics import BaseComputeMetrics
from ref_vlm.dataset.single_dataset.mixin import MInstrDataset
