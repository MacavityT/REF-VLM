...
from ref_vlm.utils import PROMPT_TEMPLATE, SYSTEM_TEMPLATE
...
def main():
    ...
    if args.lagent:
        ...
        if args.with_plugins is None:
            ...
            if calculate_open:
                from xtuner.tools.plugins import calculate  # noqa: F401
            if solve_open:
                from xtuner.tools.plugins import solve  # noqa: F401
            if search_open:
                from xtuner.tools.plugins import search  # noqa: F401
